...
const PAGEDATA={
 iphone:{why:{ru:"Почему iPhone",tj:"Чаро iPhone",en:"Why iPhone"},
  highlights:[
   {dark:1,img:IM+"iphone-17-pro/g/images/overview/cameras/intro/hero_camera__f42igewygpqy_large_2x.jpg",h:{ru:"Камеры до 48 Мп — чёткие фото и видео 4K во всей линейке.",tj:"Камераҳо то 48 Мп — аксу видеои возеҳ дар тамоми хат.",en:"Cameras up to 48MP — sharp photos and 4K video across the lineup."}},
   ...
   {dark:1,img:IM+"iphone-17-pro/g/images/overview/performance/chip/performance-hero_endframe__fazyny3rhsuy_large_2x.jpg",h:{ru:"Чип A19 — молниеносная работа и игры во всей линейке.",tj:"Чипи A19 — кор ва бозиҳои барқосо дар тамоми хат.",en:"The A19 chip — blazing performance across every model."}}],
...
const FEATURES={
 iphone:[
  {img:IM+"iphone-17-pro/g/images/overview/product-viewer/colors_orange__cr2oq3n1dwk2_large.jpg",dark:1,e:"📷",h:{ru:"iPhone 17 Pro — снимает как профи",tj:"iPhone 17 Pro — касбӣ акс мегирад",en:"iPhone 17 Pro — shoots like a pro"},p:{ru:"Три камеры по 48 Мп, оптический зум, титановый корпус и чип A19 Pro.",tj:"Се камераи 48 Мп, зуми оптикӣ, корпуси титанӣ ва чипи A19 Pro.",en:"Three 48MP cameras, optical zoom, titanium design and the A19 Pro chip."}},
  {img:IM+"iphone-air/g/images/overview/design/hero_design__capuizdf0uuu_large.jpg",dark:1,e:"📱",h:{ru:"iPhone Air — самый тонкий iPhone",tj:"iPhone Air — тунуктарин iPhone",en:"iPhone Air — the thinnest iPhone"},p:{ru:"Титановый корпус толщиной 5,6 мм, чип A19 Pro и камера 48 Мп в невероятно лёгком дизайне.",tj:"Корпуси титани 5,6 мм, чипи A19 Pro ва камераи 48 Мп дар дизайни сабук.",en:"A 5.6mm titanium design, the A19 Pro chip and a 48MP camera — incredibly light."}},
  {img:IM+"iphone-17/g/images/overview/cameras/back-camera/hero_rear_camera__baka63bo73ma_large.png",dark:1,e:"⚡",h:{ru:"iPhone 17 — всё самое главное",tj:"iPhone 17 — ҳама чизи асосӣ",en:"iPhone 17 — all the essentials"},p:{ru:"Две камеры по 48 Мп, чип A19 и дисплей ProMotion 120 Гц по доступной цене.",tj:"Ду камераи 48 Мп, чипи A19 ва дисплейи ProMotion 120 Гц.",en:"Dual 48MP cameras, the A19 chip and a 120Hz ProMotion display."}}],
 mac:[
...
const MODELS={
 ...
 ipadair:{name:"iPad Air",productId:9,price:8490,eyebrow:"iPad Air",light:true,hlLight:true,
  ...
  heroImg:A+"/v/ipad-air/ah/images/overview/hero/hero_endframe__6gl84bccyaqi_large_2x.png",
  title:{ru:"Лёгкий. Яркий. Полон сил.",tj:"Сабук. Равшан. Пур аз қувва.",en:"Light. Bright. Full of might."},
  highlights:[
   {img:A+"/v/ipad-air/ah/images/overview/chip/chip_top_endframe__bac7em7optua_large_2x.png",h:{ru:"Чип <b>M3</b> — до 2× быстрее прошлого iPad Air.",tj:"Чипи <b>M3</b> — то 2× тезтар аз iPad Air-и пешин.",en:"The <b>M3</b> chip — up to 2× faster than before."}},
   {img:A+"/v/ipad-air/ah/images/overview/cameras/cameras_endframe__cv0fbgxrv2uu_large_2x.png",h:{ru:"Фронтальная камера по центру — идеально для видеозвонков.",tj:"Камераи пеши марказӣ — барои занги видеоӣ беҳтарин.",en:"Landscape front camera — perfect for video calls."}},
   {img:A+"/v/ipad-air/ah/images/overview/apple-pencil-pro/modal/barrel_roll_endframe__d6cy5ij3s0k2_large_2x.jpg",h:{ru:"Работает с Apple Pencil Pro и Magic Keyboard.",tj:"Бо Apple Pencil Pro ва Magic Keyboard кор мекунад.",en:"Works with Apple Pencil Pro and Magic Keyboard."}},
   {img:A+"/v/ipad-air/ah/images/overview/apple-intelligence/privacy_endframe__cmahnib2pzxy_large_2x.jpg",h:{ru:"Apple Intelligence — прямо на iPad Air.",tj:"Apple Intelligence — дар iPad Air.",en:"Apple Intelligence, built right in."}}],
  explorer:[
   ...
   {label:{ru:"Чип M3",tj:"Чипи M3",en:"M3 chip"},img:A+"/v/ipad-air/ah/images/overview/chip/chip_middle_top_endframe__3zu8i1nab6ai_large_2x.png",
   ...
   {label:{ru:"Камеры",tj:"Камераҳо",en:"Cameras"},img:A+"/v/ipad-air/ah/images/overview/cameras/cameras_endframe__cv0fbgxrv2uu_large_2x.png",
   ...
   {label:{ru:"Apple Pencil",tj:"Apple Pencil",en:"Apple Pencil"},img:A+"/v/ipad-air/ah/images/overview/apple-pencil-pro/modal/hover_endframe__fkkda8kjyne6_large_2x.jpg",
 ...
 ipadbase:{name:"iPad",productId:20,price:4990,eyebrow:"iPad",light:true,hlLight:true,
  ...
  heroImg:A+"/v/ipad-11/d/images/overview/hero/hero__crzh9misvcuq_large_2x.jpg",
  title:{ru:"iPad. Как скажешь.",tj:"iPad. Чӣ хоҳӣ.",en:"iPad. Lovable. Drawable. Do-it-all-able."},
  highlights:[
   {video:A+"/105/media/us/ipad-11/2025/21af9618-666d-4368-9fb9-38822c35dc35/anim/center-stage/medium.mp4",img:A+"/v/ipad-11/d/images/overview/connect/center_stage_endframe__eu4x3duk262q_large_2x.jpg",h:{ru:"Center Stage держит вас в центре кадра на видеозвонках.",tj:"Center Stage шуморо дар маркази кадр нигоҳ медорад.",en:"Center Stage keeps you in frame on video calls."}},
   {img:A+"/v/ipad-11/d/images/overview/get-things-done/chip__buvu5472f81y_large_2x.jpg",h:{ru:"Чип <b>A16</b> — шустрый для учёбы, работы и игр.",tj:"Чипи <b>A16</b> — тез барои таҳсил, кор ва бозӣ.",en:"The <b>A16</b> chip — fast for school, work and play."}},
   {img:A+"/v/ipad-11/d/images/overview/design/snap_endframe__ej9e60w545aq_large_2x.jpg",h:{ru:"Прочный цельноалюминиевый корпус в четырёх цветах.",tj:"Корпуси якпораи алюминӣ дар чор ранг.",en:"A durable all-aluminum design in four colors."}},
   {img:A+"/v/ipad-11/d/images/overview/get-things-done/keyboard_endframe__f430b2lvfv2a_large_2x.jpg",h:{ru:"Работает с Magic Keyboard Folio и Apple Pencil.",tj:"Бо Magic Keyboard Folio ва Apple Pencil кор мекунад.",en:"Works with Magic Keyboard Folio and Apple Pencil."}}],
  explorer:[
   ...
   {label:{ru:"Чип A16",tj:"Чипи A16",en:"A16 chip"},img:A+"/v/ipad-11/d/images/overview/get-things-done/chip__buvu5472f81y_large_2x.jpg",
   ...
   {label:{ru:"Камера",tj:"Камера",en:"Camera"},img:A+"/v/ipad-11/d/images/overview/connect/camera_endframe__qioefbh5aoyi_large_2x.jpg",
   ...
   {label:{ru:"Разъёмы",tj:"Пайвастҳо",en:"Connectivity"},img:A+"/v/ipad-11/d/images/overview/ipad-accessories/usb_c_endframe__bo810y4gzrua_large_2x.jpg",
 ...
 ipadmini:{name:"iPad mini",productId:21,price:6990,eyebrow:"iPad mini",light:true,hlLight:true,
  ...
  heroImg:A+"/v/ipad-mini/v/images/overview/hero/hero_endframe__ck10nf4t7ely_large_2x.png",
  title:{ru:"Мега-мощь. Мини-размер.",tj:"Қуввати мега. Андозаи мини.",en:"Mega power. Mini size."},
  highlights:[
   {video:A+"/105/media/us/ipad-mini/2024/ab503ae9-d404-4d31-8983-47a8cb46614f/anim/express/medium.mp4",img:A+"/v/ipad-mini/v/images/overview/intelligence/express_hw_alt__d2f4nugzcaky_large_2x.jpg",h:{ru:"Apple Intelligence прямо в кармане.",tj:"Apple Intelligence дар кисаи шумо.",en:"Apple Intelligence, right in your pocket."}},
   {img:A+"/v/ipad-mini/v/images/overview/chip/powerful__fs81y3s8dfee_large_2x.jpg",h:{ru:"Чип <b>A17 Pro</b> — огромная мощь в компактном корпусе.",tj:"Чипи <b>A17 Pro</b> — қуввати бузург дар корпуси ҷайбӣ.",en:"The <b>A17 Pro</b> chip — huge power in a compact size."}},
   {img:A+"/v/ipad-mini/v/images/overview/design/liquid_retina_1__eh1ihtzkw8wi_large_2x.jpg",h:{ru:"Дисплей Liquid Retina 8,3″ — удобно в одной руке.",tj:"Дисплейи Liquid Retina 8,3″ — дар як даст бароҳат.",en:"An 8.3″ Liquid Retina display — perfect in one hand."}},
   {img:A+"/v/ipad-mini/v/images/overview/camera/rear_camera__i2x6bn0uxwii_large_2x.png",h:{ru:"Камера 12 Мп со сканированием документов.",tj:"Камераи 12 Мп бо сканкунии ҳуҷҷатҳо.",en:"A 12MP camera with document scanning."}}],
  explorer:[
   ...
   {label:{ru:"Чип A17 Pro",tj:"Чипи A17 Pro",en:"A17 Pro chip"},img:A+"/v/ipad-mini/v/images/overview/chip/powerful__fs81y3s8dfee_large_2x.jpg",
   ...
   {label:{ru:"Дисплей",tj:"Дисплей",en:"Display"},img:A+"/v/ipad-mini/v/images/overview/design/liquid_retina_2__c1svymizzic2_large_2x.png",
   ...
   {label:{ru:"Камера",tj:"Камера",en:"Camera"},img:A+"/v/ipad-mini/v/images/overview/camera/scan_documents__bt4a0xao1xiq_large_2x.png",
